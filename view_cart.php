...
<div class="viewcart">
	...
	if(isset($_SESSION["cart_session"]))
    {
		...
		echo '<span class="midigta"> <a  class="a-btn" href="Oneshopping checkout/process.php"> <span class="a-btn-text"> Pay On OneShopping</span></a></span>';
		echo '</span>';
		echo '</form>'; 
    ...
    ?>
			...
			<div id="product-slider" style="margin-top:100px;">
				<h2>Best Products</h2>
				<ul>
