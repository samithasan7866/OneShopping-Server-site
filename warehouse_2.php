...
<dl>
 ...
 <div class="clear"></div>
    ...
    <!-- Begin Main -->
    	...
    	$results = $mysqli->query("SELECT * FROM beverage where Warehouse_ID=8 ORDER BY Product_ID ASC");
        if ($results) {
        ...
        ?>
         ...
         <div class="boxes">
           <!-- Begin Shell -->
           <div class="shell">
             <div class="box post-box" style=" margin-left: 20px; padding-bottom: 20px;">
